...
public class reports_member extends javax.swing.JFrame {

    /** Creates new form reports_member */
    public reports_member() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/reports.jpg"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        String id=jTextField1.getText();
        String reports=jTextField5.getText(); 
        Admin a=new Admin();
        a.reports( id, reports);
        setVisible(false);
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reports_member.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
